      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className={`absolute top-0 right-1/4 w-[600px] h-[600px] rounded-full blur-3xl animate-pulse ${
            darkMode
              ? "bg-gradient-to-br from-amber-600/30 via-orange-600/20 to-red-600/30"
              : "bg-gradient-to-br from-amber-300/40 via-orange-300/30 to-red-300/40"
          }`}
        ...
        <div
          className={`absolute top-1/2 right-1/3 transform -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] rounded-full blur-3xl animate-pulse ${
            darkMode
              ? "bg-gradient-to-br from-purple-600/20 via-fuchsia-600/10 to-pink-600/20"
              : "bg-gradient-to-br from-purple-300/30 via-fuchsia-300/20 to-pink-300/30"
          }`}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        >
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-600 to-orange-500 flex items-center justify-center shadow-2xl ${darkMode ? 'shadow-orange-500/50' : 'shadow-orange-500/30'}`}>
        ...
        >
          ...
          <div className="relative">
            <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-500 flex items-center justify-center mx-auto mb-4 shadow-2xl ${darkMode ? 'shadow-blue-500/50' : 'shadow-blue-500/30'}`}>
              <Server className="w-8 h-8 text-white" />
            </div>
            <h2 className={`text-xl font-bold mb-3 ${darkMode ? 'text-white' : 'text-gray-900'}`}>
              100% Digital Services
            </h2>
            <p className={`text-sm leading-relaxed max-w-2xl mx-auto ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {deliveryFeatures.map((feature, index) => (
              ...
              >
                ...
                <div className="relative">
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center mb-4 shadow-xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
        ...
        >
          <div className="relative">
            <div className="flex items-center gap-3 mb-6">
              <div className={`w-10 h-10 rounded-xl bg-gradient-to-br from-violet-600 to-purple-500 flex items-center justify-center shadow-lg`}>
            ...
            <div className="space-y-4">
              {serviceDelivery.map((service, index) => (
                <motion.div
                  key={service.service}
                  className={`p-5 rounded-2xl ${darkMode ? 'bg-gray-800/50 border border-gray-700/50' : 'bg-gray-100 border border-gray-200'}`}
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className={`px-4 py-2 rounded-xl bg-gradient-to-r ${service.gradient} text-white font-bold text-sm shadow-lg flex-shrink-0 text-center`}>
                      {service.delivery}
                    </div>
                  </div>
                </motion.div>
        ...
        >
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Optimal Experience */}
              <div className={`p-5 rounded-2xl ${darkMode ? 'bg-blue-900/20 border border-blue-500/20' : 'bg-blue-50 border border-blue-200'}`}>
                <h3 className={`text-base font-bold mb-4 text-blue-500 flex items-center gap-2`}>
              ...
              <div className={`p-5 rounded-2xl ${darkMode ? 'bg-emerald-900/20 border border-emerald-500/20' : 'bg-emerald-50 border border-emerald-200'}`}>
                <h3 className={`text-base font-bold mb-4 text-emerald-500 flex items-center gap-2`}>
                  <CheckCircle2 className="w-5 h-5" />
                  Service Availability
                </h3>
                <ul className="space-y-3">
        ...
        >
          ...
          <div className="relative">
            <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-600 to-orange-500 flex items-center justify-center mx-auto mb-4 shadow-2xl ${darkMode ? 'shadow-orange-500/50' : 'shadow-orange-500/30'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 rounded-xl text-base font-bold text-white bg-gradient-to-r from-amber-600 via-orange-600 to-red-600 hover:shadow-2xl hover:shadow-orange-500/50 transition-all duration-300 hover:scale-105 shadow-xl"
              >
